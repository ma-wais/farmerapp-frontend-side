  ...
  return (
    ...
    <div className='layout m20 contentBetween'  
      ...
      <div>
        ...
        <div  style={{width:'70%',display:'inline-block',padding:'15px 0 10px 10px'}} >
        <p className="textSM textDark">Plan 1</p>
        <p style={{padding:'0px 0 5px 0px'}}>₹50/ 5 questions </p>
        </div>
      </div>
      <NavLink to={"/app/advisory/payment"} style={{height:'70%', width:'20%',margin:"5% 0px 0 0"}} >
        <img src={Arrow} 
        style={{width:'50%',minWidth:'50px', borderRadius:'10px',padding:'10px'}}  alt="" />
      </NavLink>
    </div>
    <div className='layout m20 contentBetween'  
        style={{borderRadius:'10px',border:'1px solid rgb(200,200,200)',}} >
    ...
    </div> <div className='layout m20 contentBetween'  
        style={{borderRadius:'10px',border:'1px solid rgb(200,200,200)',}} >
      <div className='flex '>
      <div style={{backgroundImage:backgroundImageUrl,}}>
         <img src={diamond} className="pl20 p20"
        ...
        <div  style={{width:'60%',display:'inline-block',padding:'15px 0 10px 10px'}} >
