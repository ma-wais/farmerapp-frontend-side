...
const UserSubscriptions:React.FC = () => {
  return (
    ...
    <div className="layout m40">
        ...
        <img src={ArrowUP} style={{width:'20px',marginLeft:'10px'}}  alt="" />
    </div>
    <div className='layout m20 contentBetween'  
      ...
      <div >
        ...
        <p style={{padding:'0px 0 5px 0px',color:'black'}}>₹50/ 5 questions </p>
    ...
    <div className='layout m20 contentBetween'  
      ...
      <div >
        ...
        <div  style={{width:'80%',display:'inline-block',padding:'15px 0 10px 10px'}} >
        <p className="textSM">Plan 1</p>
        <p style={{padding:'0px 0 5px 0px',color:'black'}}>₹150/ 10 questions  </p>
