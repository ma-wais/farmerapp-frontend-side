    ...
    <Layout showUI goBack>
      <Box className="profileBG">
        ...
        <Box className="profileContainer">
          ...
          <Box className="userName">Karna</Box>
        </Box>
      </Box>
      ...
      <Box className="accountDetails m40">
        ...
        <Box className="textCenter">
          <Typography className="heading">309</Typography>
          <Typography>Followers</Typography>
        </Box>
        <Box className="textCenter">
          <Typography className="heading">100</Typography>
          <Typography>Posts</Typography>
        </Box>
      </Box>
      <NavLink
        to={"/#"}
        className="btn block m20"
        style={{
          color: "#C89963",
      ...
      <Box className="categoriesList">
        ...
        <Box className="bage primary">Market Trends</Box>
        <Box className="bage primary">Lorem Ipsum</Box>
      </Box>
        ...
        <Box className="card">
          <Box className="header">
            <Box className="profile">
              ...
              <Box>
                <Typography className="name">Karna</Typography>
