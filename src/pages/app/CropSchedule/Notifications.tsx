    ...
    <Layout showUI goBack pageTitle="Notifications">
      <div>
        ...
        >
          ...
          >
            <p className="textSM textDark">
              Tellus at sit ante rutrum suspendisse pretium, vitae vel
              dignissim.
            </p>
            <p>9:01am </p>
          </div>
          <img
            src={Arrow}
            style={{ width: "30px", borderRadius: "10px", marginRight: "20px" }}
            alt=""
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div
          className="layout contentBetween m20"
          style={{ borderRadius: "10px" }}
        >
          <img
            src={diamond2}
