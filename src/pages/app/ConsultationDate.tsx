   ...
   <Layout showUI goBack pageTitle='Book Consultation'>
    ...
    <NavLink
      ...
      <div className='p40 layout '>
        <p className='textMD textDark' style={{marginLeft:'10px',borderRadius:'10px',border:'1px solid #ccc',padding:'15px 6px'}}>03:00 pm - 04:00pm</p>
        <p className='textMD textDark' style={{marginLeft:'20px',borderRadius:'10px',border:'1px solid #ccc',padding:'15px 6px'}}>03:00 pm - 04:00pm</p>
      </div>
      <div className='p40 layout'>
