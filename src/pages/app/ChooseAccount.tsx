        ...
        <Layout showUI={false}>
            <Box className="textCenter">
                ...
                <Typography sx={{ marginTop: "12px" }}>
                    Welcome! Let's get started by selecting which account you want to proceed.
                </Typography>
            </Box>
            <ul className='list radioList bordered' style={{ marginTop: "41px" }}>
                <li onClick={()=>setAccount('farmer')}>
                    ...
                    <IoCheckmarkCircle className='checkmark msAuto' size={'1.8em'} color='#CA9B64' />
                </li>
            ...
            <NavLink to={`${account === '' ? '#!': '/app/signup'}`} className={`${account === '' ? 'disable': ''} btn primary block mtAuto`}>
                Proceed
            </NavLink>
        </Layout>
    )
