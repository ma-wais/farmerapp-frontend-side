  ...
  return (
    <div>
        ...
        <div className='ml20 mr20'>
            ...
            <div className='layout contentBetween'>
                <p className='textSM' style={{width:'55%'}}>Active Ingredient</p>
                <p className='mr20' >Paclobutrazol 23% w/w SC</p>
            </div>
            <div className='layout contentBetween'>
                <p className='textSM' style={{width:'60%'}}>Available Pack Sizez </p>
            ...
            <NavLink to={'/app/ECommerse/categories'} style={{textDecoration:'none'}}>
                <h3 className="textPrimary">See All</h3>
            </NavLink>
            </div>
            <div className="layout flexRow" style={{ overflowX: 'scroll',flexWrap:'nowrap'}}>
                {days.map((day, index) => (
                    <div
                        className="flexColumn" key={index}
                        style={{ border: "1px solid #E9E9E9", minWidth:'200px', height:'270px', borderRadius: "10px"
                    }}
                    >
                    <img src={product} alt="" style={{width:'100%',height:'60%',borderRadius:'10px'}} />
                    ...
                    <p className='textMD'>Lorem Ipsum</p>
                    <div className='layout contentBetween'>
                        <p>Date and Time |<img src={coins} alt="coins" style={{width:'20px',marginLeft:'5px'}}/> Earn coins</p>
                        <NavLink to={'!#'}>
            ...
            <div className='layout'>
                <div style={{width:'75%'}}>
                    <div className='layout m20'>
                        ...
                        <div style={{width:'100%',height:'10px',backgroundColor:'#FFB400', margin:'10px'}}></div>
                    </div>
                    <div className='layout m20'>
                        <p className='textMD'>4</p>
                        <div style={{width:'100%',height:'10px',backgroundColor:'rgba(0, 0, 0, 0.06)', margin:'10px'}}>
                            <div style={{width:'80%',height:'10px',backgroundColor:'#FFB400'}}></div>
                        </div>
                    </div>
                    <div className='layout m20'>
                        <p className='textMD'>3</p>
                        <div style={{width:'100%',height:'10px',backgroundColor:'rgba(0, 0, 0, 0.06)', margin:'10px'}}>
                            <div style={{width:'60%',height:'10px',backgroundColor:'#FFB400'}}></div>
                        </div>
                    </div>
                    <div className='layout m20'>
                        <p className='textMD'>2</p>
                        <div style={{width:'100%',height:'10px',backgroundColor:'rgba(0, 0, 0, 0.06)', margin:'10px'}}>
                            <div style={{width:'40%',height:'10px',backgroundColor:'#FFB400'}}> </div>
                        </div>
                    </div>
                    <div className='layout m20'>
                        <p className='textMD'>1</p>
                        <div style={{width:'100%',height:'10px',backgroundColor:'rgba(0, 0, 0, 0.06)', margin:'10px'}}>
                            <div style={{width:'20%',height:'10px',backgroundColor:'#FFB400'}}></div>
                        </div>
                    </div>
                </div>
                <div className='layout flexColumn' style={{width:'25%',margin:'80px 1px'}}>
                    <div className='layout'>
                        <p className='heading'>4.5</p>
                        <img src={star} alt="star" style={{width:'20px',marginLeft:'5px'}}/>
                    </div>
                    <p className='textSM m20'>273 Reviews</p>
                </div>
            </div>
            <div className='m20' style={{borderRadius:'10px',border:'1px solid rgb(200,200,200)',}}>
                <div className='layout contentBetween' >
                    <div className='flex '>
                        <div>
                            <img src={diamond} className="pl20 p20"
                                style={{width:'80px', borderRadius:'10px',}}  alt="" />
                        </div>
                        <div className='ml20' style={{width:'70%',display:'inline-block'}} >
                    ...
                    <div className='layout m20' >
                        <img src={star}  alt="" />
                        <p className='m20' style={{margin:'23px 20px 0 10px'}}>4.5</p>
                    </div>
                </div>
                <p className='textMD m20 ml20' style={{color:'#939393'}}> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
      ...
      <div className="layout flexRow m20" style={{ overflowX: 'scroll',width: "95%",flexWrap:'nowrap'}}>
        {days.map((day, index) => (
            <div
              className="flexColumn ml20" key={index}
              style={{
                border: "1px solid #E9E9E9", minWidth:'200px', height:'130px',
                borderRadius: "10px",
                padding: "5px",
                backgroundImage: `url(${motor})`, backgroundSize: 'cover', backgroundPosition: 'center'
              }}
            >
            </div>
        ))}
