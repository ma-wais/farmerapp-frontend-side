...
const Onboarding: React.FC = () => {
    return (
        <Layout showUI={false} style={{ padding: 0 }}>
            ...
            <Box className="bottomSheet" sx={{ marginTop: "auto", position: "relative" }}>
                <Box sx={{ position:"absolute", top: '-20px', left:'0', width: '100%' }}>
                ...
                <NavLink to="/app/chooseAccount" className="btn primary block" style={{ marginTop: "75px" }}>Next</NavLink>
            </Box>
        </Layout>
    )
}
