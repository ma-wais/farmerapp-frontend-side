...
const App: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path={`/${URL_PREFIX}/ECommerse/Categories`} Component={Categories} /> 
      <Route path={`/${URL_PREFIX}/ECommerse/CategoryItems`} Component={CategoryItems} /> 
      <Route path={`/${URL_PREFIX}/ECommerse/itemdetails`} Component={ItemDetails} /> 
      <Route path={`/${URL_PREFIX}/ECommerse/Cart`} Component={Cart} /> 
      <Route path={`/${URL_PREFIX}/ECommerse/Checkout`} Component={Checkout} /> 
      <Route path={`/${URL_PREFIX}/ECommerse/OrderSuccess`} Component={OrderSuccess} /> 
